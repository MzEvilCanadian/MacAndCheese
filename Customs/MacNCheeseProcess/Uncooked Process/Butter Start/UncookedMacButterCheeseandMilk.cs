...
{
    class UncookedMacButterCheeseandMilk: CustomItemGroup
    {
        public override string UniqueNameID => "Uncooked Mac Butter Cheese and Milk";
        ...
        public override List<ItemGroup.ItemSet> Sets => new List<ItemGroup.ItemSet>()
        {
            new ItemGroup.ItemSet()
            {
                ...
                Items = new List<Item>()
                {
                    Main.UncookedMacButterandCheese
                }
            },
            new ItemGroup.ItemSet()
            {
