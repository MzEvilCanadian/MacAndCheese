...
{
    class UncookedMacMilkButterandCheese : CustomItemGroup
    {
        public override string UniqueNameID => "Uncooked Mac Milk Butter and Cheese";
