...
{
    class UncookedMacCheeseButterandMilk : CustomItemGroup
    {
        public override string UniqueNameID => "Uncooked Mac Cheese Butter and Milk";
        ...
        public override List<ItemGroup.ItemSet> Sets => new List<ItemGroup.ItemSet>()
        {
            new ItemGroup.ItemSet()
            {
                ...
                Items = new List<Item>()
                {
                    Main.UncookedMacCheeseandButter
                }
            },
            new ItemGroup.ItemSet()
            {
